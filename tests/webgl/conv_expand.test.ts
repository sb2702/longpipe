...
import fixture from '../fixtures/conv_expand.json'

const THRESHOLD = 1e-4

describe('ConvExpand (WebGL)', () => {
  it('N→2 conv 3x3 + relu matches PyTorch', async () => {
    ...
    const op = backend.ops.ConvExpand(input, { weights: fixture.weights, bias: fixture.bias })
    op.run()
