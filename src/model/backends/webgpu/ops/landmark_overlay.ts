...
export class LandmarkOverlayWebGPU {
  ...
  constructor(
    ...
    // Params: { img_w, count: u32, thresh, point_size: f32, color: vec4, canvas: vec4 }
    ...
    new Float32Array(ab, 16, 4).set([...params.color, 1])
    new Float32Array(ab, 32, 4).set([image.w, image.h, 0, 0])
